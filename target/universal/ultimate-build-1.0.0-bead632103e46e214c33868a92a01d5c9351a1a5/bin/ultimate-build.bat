@REM ultimate-build launcher script
@REM
@REM Environment:
@REM JAVA_HOME - location of a JDK home dir (optional if java on path)
@REM CFG_OPTS  - JVM options (optional)
@REM Configuration:
@REM ULTIMATE_BUILD_config.txt found in the ULTIMATE_BUILD_HOME.
@setlocal enabledelayedexpansion

@echo off

if "%ULTIMATE_BUILD_HOME%"=="" set "ULTIMATE_BUILD_HOME=%~dp0\\.."

set "APP_LIB_DIR=%ULTIMATE_BUILD_HOME%\lib\"
...
set "CFG_FILE=%ULTIMATE_BUILD_HOME%\ULTIMATE_BUILD_config.txt"
set CFG_OPTS=
if exist %CFG_FILE% (
...
if "%JAVAOK%"=="false" (
  ...
  echo and download a valid Java JDK and install before running ultimate-build.
  echo.
...
"%_JAVACMD%" !_JAVA_OPTS! !ULTIMATE_BUILD_OPTS! -cp "%APP_CLASSPATH%" %MAIN_CLASS% !_APP_ARGS!
